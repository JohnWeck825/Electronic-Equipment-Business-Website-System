...
//             time: 1000,
//         });
//         setCookie("notifyShown", true, 1); // Cookie sẽ hết hạn sau 1 ngày
//     }
// }
//
...
//  C2
// function checkAndNotify() {
//     if (!sessionStorage.getItem("notifyShown")) {
//         $.notify({
//             icon: 'flaticon-alarm-1',
//             title: 'Welcome Back',
//             message: 'Have a nice day',
...
// Kiểm tra nếu chưa có cookie 'firstLoad' thì hiển thị thông báo
$(document).ready(function () {
    const firstLoad = getCookie('firstLoad');

    if (!firstLoad) {  // Nếu chưa có cookie, thông báo sẽ hiển thị
        $.notify({
            icon: 'flaticon-alarm-1',
            title: 'Welcome Back',
            message: 'Have a nice day',
        ...
        // Thiết lập cookie để đánh dấu lần tải đầu tiên
        setCookie('firstLoad', 'true', 1); // Cookie tồn tại 1 ngày
    }
});
//
